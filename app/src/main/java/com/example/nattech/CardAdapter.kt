...
import com.example.nattech.fragments.ChartFragment
import com.example.nattech.fragments.ControlFragment
import com.sjapps.library.customdialog.CustomViewDialog
import java.util.Calendar
import java.util.Date

class CardAdapter(val data: Cursor): RecyclerView.Adapter<CardViewHolder>() {
...
//        val year = calendar.get(Calendar.YEAR) + 543
        ...
        holder.itemView.setOnClickListener(object: View.OnClickListener{
            override fun onClick(v: View?) {
                ...
                fragment.supportFragmentManager.beginTransaction().replace(R.id.container, controller).addToBackStack(null).commit()
            }
        })
